...
// Dialect dialect = DialectFactory.createDialect(DialectDriverType.MYSQL);

// // Demo: Dialect info
// System.out.println("✅ Dialect Name: " + dialect.getDialectName());
...
// for (DialectDriverType type : DialectFactory.getSupportedDialects()) {
// System.out.println(" - " + type);
// }

// // Create dialect by type
// Dialect mysqlDialect = DialectFactory.createDialect(DialectDriverType.MYSQL);
...
// System.out.println(" Same instance: " + (mysqlDialect.getClass() ==
// dialectByName.getClass()));

// // Check support
// boolean isSupported = DialectFactory.isSupported(DialectDriverType.MYSQL);
